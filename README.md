...
![](https://github.com/JollyCorivuG/csbot/blob/main/docs/images/词法类型.PNG)

对于每一种词法类型，又包含具体的词汇。

关键字：

![](https://github.com/JollyCorivuG/csbot/blob/main/docs/images/关键字.PNG)
...
![](https://github.com/JollyCorivuG/csbot/blob/main/docs/images/分隔符.PNG)

运算符：

![](https://github.com/JollyCorivuG/csbot/blob/main/docs/images/运算符.PNG)
...
![](https://github.com/JollyCorivuG/csbot/blob/main/docs/images/系统架构图.png)
...
![](https://github.com/JollyCorivuG/csbot/blob/main/docs/images/解释器目录结构.png)
...
![](https://github.com/JollyCorivuG/csbot/blob/main/docs/images/解释器核心模块划分.png)

由于每个主模块中包含若干个子模块，因此这里用一张**模块结构图**来表示各个模块之间的调用关系以及包含关系：

![](https://github.com/JollyCorivuG/csbot/blob/main/docs/images/解释器模块关系图.png)
...
![](https://github.com/JollyCorivuG/csbot/blob/main/docs/images/设计模式.png)
